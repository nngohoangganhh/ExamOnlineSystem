...
public class UserImportService {
    ...
    private ImportUserRowResult processRow(Map<String, String> row,
        ...
        // --- Xác định Role ---
        // Fallback "STUDENT" nếu cả cột role trong file lẫn defaultRole
        // truyền vào đều rỗng/null, tránh NPE khi gọi defaultRole.toUpperCase().
        String fallbackRole = (defaultRole != null && !defaultRole.isBlank())
        ...
        // Validate role hợp lệ bằng cách tra thẳng DB (roleRepository) thay vì
        // hardcode List.of("STUDENT","TEACHER","ADMIN"): nếu sau này có thêm
        // role mới trong bảng roles, code cũ sẽ luôn từ chối role đó dù nó
        // hợp lệ trong DB.
